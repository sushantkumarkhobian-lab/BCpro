...
app = FastAPI(
    ...
    description=(
        "Deterministic Blockchain Forensics Engine for USDT-TRC20 (Tron). "
...
if __name__ == "__main__":
    ...
    print(f" Target Chain : Tron (USDT-TRC20)")
    print(f" Ingestion    : {'MOCK DATA MODE' if settings.USE_MOCK_DATA else 'LIVE TRON API MODE'}")
